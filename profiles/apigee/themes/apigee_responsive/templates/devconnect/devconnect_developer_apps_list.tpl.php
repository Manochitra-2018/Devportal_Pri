...
<?php if ($application_count): ?>
  ...
  <?php foreach ($applications as $app): ?>
    ...
    <?php if (user_access("edit developer apps")): ?>
              <li class="hidden-xs apigee-modal-link-edit"><a href="<?php print base_path() . $app['edit_url']; ?>"  data-target="#edit-<?php print $app['id']; ?>"><?php print t('Edit "%n"', array('%n' => $app['app_name'])); ?></a></li>
              <li class="visible-xs apigee-modal-link-edit"><a href="<?php print base_path() . $app['edit_url']; ?>" data-target="#edit-<?php print $app['id']; ?>"><?php print t('Edit'); ?></a></li>
